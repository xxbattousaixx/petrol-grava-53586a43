export const translations = {
  ...
  policies: {
    ...
    safety: {
      ...
      intro: {
        es: "PETROL GRAVA SERVICES C.A., una Empresa dedicada al Servicio de Muelle (Varal, Desguace, Mantenimiento y Construcción Naval), Espacios en Tierra ideal para Reparación de Equipos Pesados, Servicios de Fabricación y Soldadura, Tratamientos de superficies para aplicación de Pinturas, Servicios de elaboración de Proyectos Navales, Civiles y Eléctricos, Mantenimiento Menor y Mayor a Unidades lacustres, Reparación de Atracaderos y Barandas, Reparación Menor de Equipos de Superficie y Reparación de Líneas Metálicas.",
        en: "PETROL GRAVA SERVICES C.A., a company dedicated to Dock Services (Slipway, Scrapping, Maintenance and Naval Construction), Land Space ideal for Heavy Equipment Repair, Fabrication and Welding Services, Surface Treatments for Paint Application, Naval, Civil and Electrical Project Development Services, Minor and Major Maintenance of Lacustrine Units, Dock and Railing Repair, Minor Surface Equipment Repair and Metal Line Repair.",
      },
      body: {
...
export const servicesData = [
  ...
  },
  {
    ...
    title: { es: "Espacios en Tierra para Reparación de Equipos Pesados", en: "Land Space for Heavy Equipment Repair" },
  ...
  },
  {
    ...
    gallery: ["service-sandblasting", "service-sandblasting-2", "service-sandblasting-3", "service-sandblasting-4", "service-sandblasting-5", "service-sandblasting-6", "service-sandblasting-8", "service-sandblasting-9", "service-sandblasting-10"],
  },
  {
    id: "limpieza-presion",
