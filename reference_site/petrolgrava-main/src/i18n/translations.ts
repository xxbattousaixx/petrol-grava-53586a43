...
export const translations = {
  ...
  hero: {
    title: { es: "Petrol Grava Services C.A", en: "Petrol Grava Services C.A" },
    subtitle: {
  ...
  about: {
    ...
    subtitle: { es: "Confianza y Experiencia desde 1996", en: "Trust and Experience since 1996" },
    description: {
  ...
  services: {
    ...
    subtitle: {
      es: "Soluciones integrales para la industria petrolera y lacustre",
      en: "Comprehensive solutions for the oil and lacustrine industry",
    },
...
export const servicesData: ServiceData[] = [
  ...
  },
  {
    ...
    fullDesc: {
      es: "Realizamos servicios de reemplazo de aceros bajo el agua con buzos certificados y equipos especializados para trabajos subacuáticos. Este servicio es esencial para la reparación y mantenimiento de embarcaciones, plataformas y estructuras sumergidas sin necesidad de sacar la unidad del agua. Nuestro equipo de buzos comerciales está certificado y cuenta con la experiencia necesaria para ejecutar soldaduras subacuáticas, corte de aceros, inspecciones y reparaciones estructurales bajo el agua.\n\nAdicionalmente, ejecutamos proyectos de mantenimientos mayores a unidades lacustres y equipos industriales, abarcando desde la planificación hasta la entrega final del trabajo. Nuestro servicio incluye inspección detallada, elaboración de plan de trabajo, ejecución de reparaciones estructurales, mecánicas, eléctricas y de sistemas de navegación. Contamos con personal multidisciplinario calificado y más de 27 años de experiencia en el sector, garantizando la calidad y seguridad en cada proyecto ejecutado.",
      en: "We perform underwater steel replacement services with certified divers and specialized equipment for underwater work. This service is essential for repairing and maintaining vessels, platforms, and submerged structures without the need to remove the unit from the water. Our team of commercial divers is certified and has the necessary experience to execute underwater welding, steel cutting, inspections, and structural repairs underwater.\n\nAdditionally, we execute major maintenance projects for lacustrine units and industrial equipment, covering from planning to final delivery. Our service includes detailed inspection, work plan preparation, execution of structural, mechanical, electrical, and navigation system repairs. We have qualified multidisciplinary personnel and over 27 years of experience in the sector, guaranteeing quality and safety in every project executed.",
    },
